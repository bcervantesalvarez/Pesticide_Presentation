...
ggsurvplot(fit= survfit(Surv(temp18$TTKD, temp18$status)~temp18$pesticide), data = temp18) +
...
ggsurvplot(fit= survfit(Surv(temp24$TTKD, temp24$status)~temp24$pesticide), data = temp24) +
...
ggsurvplot(fit= survfit(Surv(temp30$TTKD, temp30$status)~temp30$pesticide), data = temp30) +
